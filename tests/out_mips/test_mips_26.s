...
#	NODE tmp$10(3) COST - 200.000000, DEGREES - 3
...
#	NODE tmp$16(8) COST - 500.000000, DEGREES - 6
#	NODE b(9) COST - 2000.000000, DEGREES - 6
#	NODE tmp$19(10) COST - 250.000000, DEGREES - 4
#	NODE tmp$20(11) COST - 500.000000, DEGREES - 4
#	NODE tmp$12(12) COST - 50.000000, DEGREES - 4
#	NODE tmp$7(13) COST - 100.000000, DEGREES - 2
#	NODE tmp$3(14) COST - 10.000000, DEGREES - 0
#	NODE tmp$3(14) IN REG $s0
#	NODE tmp$7(13) IN REG $s1
#	NODE tmp$12(12) IN REG $s4
#	NODE tmp$20(11) IN REG $s2
#	NODE tmp$19(10) IN REG $s2
#	NODE b(9) IN REG $s6
#	NODE tmp$16(8) IN REG $s5
#	NODE tmp$6(7) IN REG $s5
#	NODE a(6) IN REG $s4
#	NODE tmp$2(4) IN REG $s4
#	NODE tmp$10(3) IN REG $s1
#	NODE j(2) IN REG $s3
