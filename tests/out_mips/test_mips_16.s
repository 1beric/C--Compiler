...
#	NODE tmp$58(23) COST - 1.000000, DEGREES - 0
#	NODE tmp$57(24) COST - 1.000000, DEGREES - 0
#	NODE tmp$23(25) COST - 1.000000, DEGREES - 0
#	NODE tmp$62(26) COST - 0.000000, DEGREES - 0
#	NODE tmp$55(27) COST - 1.000000, DEGREES - 0
#	NODE tmp$54(28) COST - 1.000000, DEGREES - 0
#	NODE tmp$53(29) COST - 1.000000, DEGREES - 0
#	NODE tmp$30(30) COST - 1.000000, DEGREES - 0
#	NODE tmp$64(31) COST - 0.000000, DEGREES - 0
#	NODE tmp$51(32) COST - 1.000000, DEGREES - 0
#	NODE tmp$31(33) COST - 1.000000, DEGREES - 0
#	NODE tmp$34(34) COST - 1.000000, DEGREES - 0
#	NODE tmp$48(35) COST - 1.000000, DEGREES - 0
#	NODE tmp$66(36) COST - 0.000000, DEGREES - 0
#	NODE tmp$35(37) COST - 1.000000, DEGREES - 0
#	NODE tmp$46(38) COST - 1.000000, DEGREES - 0
#	NODE tmp$45(39) COST - 1.000000, DEGREES - 0
#	NODE tmp$44(40) COST - 1.000000, DEGREES - 0
#	NODE tmp$39(41) COST - 1.000000, DEGREES - 0
#	NODE tmp$60(42) COST - 1.000000, DEGREES - 0
...
# out = 0000000000000000000000000000000000000000000000;
    ...
    # block (0)
    # livenow=0000000000000000000000000000010000000000000000
    # add addr(y), tmp$53, tmp$52
    la $t0, _y
    move $t1, $s0	# tmp$53
    add $t2, $t0, $t1
    sw $t2, -156($fp)	# tmp$52, -1
    ...
    # block (0)
    # livenow=0000000000000000000000000000000010000000000000
    ...
    # block (0)
    # livenow=0000000000000000000000000000000000100000000000
    # add addr(y), tmp$49, tmp$48
    la $t0, _y
    lw $t1, -292($fp)	# tmp$49
    add $t2, $t0, $t1
    sw $t2, -276($fp)	# tmp$48, -1
    ...
    li $t1, 4
    mul $t2, $t0, $t1
    sw $t2, -256($fp)	# tmp$47, -1

    # block (0)
    # livenow=0000000000000000000000000000000000000100000000
    # add addr(x), tmp$47, tmp$46
    la $t0, -24($fp)	# addr(x)
    lw $t1, -256($fp)	# tmp$47
    add $t2, $t0, $t1
    sw $t2, -232($fp)	# tmp$46, -1
    ...
    # block (0)
    # livenow=0000000000000000000000000000000000000000010000
    # mul tmp$68, 4, tmp$43
    lb $t0, -293($fp)	# tmp$68
    li $t1, 4
    mul $t2, $t0, $t1
    sw $t2, -160($fp)	# tmp$43, -1
    ...
    # block (0)
    # livenow=0000000000000000000000000000000000000000000010
    # add addr(y), tmp$41, tmp$40
    la $t0, _y
    move $t1, $s0	# tmp$41
    add $t2, $t0, $t1
    sw $t2, -92($fp)	# tmp$40, -1
