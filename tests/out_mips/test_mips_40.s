...
#	NODE y(0) COST - 32.000000, COST/DEG - 8.000000
#	NODE i(1) COST - 70.000000, COST/DEG - 17.500000
#	NODE x(2) COST - 30.000000, COST/DEG - 7.500000
#	NODE tmp$2(3) COST - 10.000000, COST/DEG - 5.000000
#	NODE tmp$3(4) COST - 10.000000, COST/DEG - 5.000000
#	NODE tmp$5(5) COST - 10.000000, COST/DEG - 5.000000
.text
# function f
# formals: i (loc: 8); 
...
#	LIVERANGE: EDGE x(0) -> tmp$8(1)
#	LIVERANGE: EDGE x(0) -> tmp$10(2)
#	LIVERANGE: EDGE tmp$8(1) -> tmp$10(2)
#	LIVERANGE -- ERR VAL(5) WAS NULL a
#	LIVERANGE -- ERR VAL(5) WAS NULL a
#	LIVERANGE -- ERR VAL(4) WAS NULL a
#	LIVERANGE -- ERR VAL(4) WAS NULL a
#	LIVERANGE: EDGE a(3) -> x(0)
#	LIVERANGE: EDGE a(3) -> tmp$8(1)
#	LIVERANGE: EDGE a(3) -> tmp$10(2)
#	NODE x(0) COST - 35.000000, COST/DEG - 8.750000
#	NODE tmp$8(1) COST - 1.000000, COST/DEG - 0.250000
#	NODE tmp$10(2) COST - 1.000000, COST/DEG - 0.250000
.text
# function main
# formals: 
