...
#	NODE tmp$3(1) COST - 1.000000, COST/DEG - 0.500000
#	NODE tmp$1(2) COST - 0.500000, COST/DEG - 0.250000
#	NODE tmp$4(3) COST - 2.000000, COST/DEG - 1.000000
#	NODE tmp$8(4) COST - 2.000000, COST/DEG - 2.000000
.text
# function f
# formals: n (loc: 8); 
...
#	LIVERANGE: EDGE tmp$12(1) -> tmp$17(4)
#	NODE n(0) COST - 6.000000, COST/DEG - 6.000000
#	NODE tmp$12(1) COST - 1.000000, COST/DEG - 0.333333
#	NODE tmp$10(2) COST - 0.500000, COST/DEG - 0.250000
#	NODE tmp$13(3) COST - 2.000000, COST/DEG - 1.000000
#	NODE tmp$17(4) COST - 2.000000, COST/DEG - 1.000000
.text
# function g
# formals: n (loc: 8); 
...
#	LIVERANGE -- ERR VAL(4) WAS NULL b
...
#	LIVERANGE -- ERR VAL(1) WAS NULL a
#	LIVERANGE -- ERR VAL(4) WAS NULL b
#	NODE tmp$18(0) COST - 1.000000, COST/DEG - 1.000000
.text
# function main
# formals: 
